...
let abrams = new product("images/a1Abrams.jpg", "Firing 40 pounds of depleted Uranium at your Cranium", 3000000, 0, "A1 Abrams", "abr");
let warthog = new product("images/a10Warthog.jpg", "Literally to angry to die Energy, the Flying Warcrime", 3500000, 0, "A10 Warthog", "war");
let ac130 = new product("images/ac130.jpg", "Minigun go Brrrrrrt", 9000000, 0, "AC130", "ac1");
let apache = new product("images/apache.jpg", "If you are reading this you are already dead", 4000000, 0, "Apache Longbow", "apa");
let iowa = new product("images/iowa.jpg", "45,000 tons of 16 inch Freedom", 15000000, 0, "USS Iowa", "iow");
let bradley = new product("images/bradley.jpg", "Push up with the Bradley *Explosion* F#@K, the Bradley's down.", 2500000, 0, "Bradley", "brad");
let f16 = new product("images/f16.jpg", "Dear Grid Coordinates, you no longer exist,<br>Sincerly F16", 7000000, 0, "F16", "f1");
let huey = new product("images/huey.jpg", "Fortunate Son Intensifies", 5000000, 0, "Huey", "hue");
